...
"""
This file splits an image with a size of n x n into several small parts and mixes them randomly. The small parts are 
then added on a transparent background.
